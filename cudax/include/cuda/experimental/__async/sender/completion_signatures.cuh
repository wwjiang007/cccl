...
struct _CCCL_TYPE_VISIBILITY_DEFAULT completion_signatures
{
  ...
  using __transform_q _CCCL_NODEBUG_ALIAS =
    _Continuation<_CUDA_VSTD::__type_apply_q<_Fn, _CUDA_VSTD::__as_type_list<_Sigs>>...>;
...
_CUDAX_API auto __make_unique(_Sigs*...)
  -> _CUDA_VSTD::__type_apply<_CUDA_VSTD::__type_quote<completion_signatures>,
                              _CUDA_VSTD::__as_type_list<_CUDA_VSTD::__make_type_set<_Sigs...>>>;
